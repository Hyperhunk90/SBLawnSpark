        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-background-card to-background-dark rounded-2xl shadow-2xl p-8 border border-accent-gold/20">
                <div className="text-center">
                  <FaUser className="text-5xl text-accent-gold mx-auto mb-6" />
                  <blockquote className="text-xl font-medium mb-6 text-white leading-relaxed">
                    "Your yard isn't just grass and plants - it's where life happens. 
                    I treat every property like my own."
                  </blockquote>
                  <cite className="text-accent-gold font-semibold text-lg">
                    — Shane Dantone, Owner
                  </cite>
                  <div className="mt-6 p-4 bg-primary-orange/10 rounded-xl border border-primary-orange/20">
                    <div className="text-3xl font-bold text-primary-orange mb-1">13+</div>
